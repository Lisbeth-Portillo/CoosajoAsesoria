                ...
                <div class="col-12">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input type="text" class="form-control" id="Propietario" placeholder="" title="" value="1">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-9">
                        <input type="date" class="form-control" id="" value="2019-02-04">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ubicacion" class="col-lg-3 col-form-label">Hora</label>
                      <div class="col-lg-9">
                        <input type="time" class="form-control" id="" value="20:45">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ubicacion" class="col-lg-3 col-form-label">Duración</label>
                      <div class="col-lg-9">
                        <input type="time" class="form-control" id="" value="02:25" max="05:00">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ubicacion" class="col-lg-3 col-form-label">Modalidad</label>
                      <div class="col-lg-9">
                        <input type="date" class="form-control" id="" value="Virtual">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="ubicacion" class="col-lg-3 col-form-label">Lugar/Plataforma</label>
                      <div class="col-lg-9">
                        <input type="date" class="form-control" id="" value="Teams">
                      </div>
                    </div>
                  </div>
